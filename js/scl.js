...
function sendDataToServer(data) {
	$.ajax({
    url: 'https://script.google.com/macros/s/AKfycbxnuYte-gY2Db4xB7Y8k09Dea7kqlKqUmJUQLUhCiN3jdlx_t-NESqqJYRn6C4pmkzC/exec',
		type: 'post',
    data: data,
    complete: function(){
      window.location.replace("https://app.prolific.co/submissions/complete?cc=71F5488E") // redirect to prolific
    } 
	});
}
